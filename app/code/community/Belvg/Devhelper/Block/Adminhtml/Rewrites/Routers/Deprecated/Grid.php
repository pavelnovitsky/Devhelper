...
class Belvg_Devhelper_Block_Adminhtml_Rewrites_Routers_Deprecated_Grid extends Belvg_Devhelper_Block_Adminhtml_Devhelper_Grid {
    ...
    protected function _prepareCollection() {
        $collection = Mage::getResourceModel('devhelper/deprecated_collection');
        $collection->_prepare();
