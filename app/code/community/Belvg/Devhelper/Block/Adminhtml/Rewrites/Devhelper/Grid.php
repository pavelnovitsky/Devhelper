...
class Belvg_Devhelper_Block_Adminhtml_Rewrites_Devhelper_Grid extends Belvg_Devhelper_Block_Adminhtml_Devhelper_Grid {
    ...
    protected function _prepareCollection() {
        $collection = Mage::getResourceModel('devhelper/devhelper_collection');
